    ...
    >
      <div className="max-w-[1440px] mx-auto">
          ...
          <nav className="flex flex-wrap gap-x-10 gap-y-4">
            {[
              ...
              <Link
                key={label}
                href={href}
                className="font-body text-[10px] tracking-widest text-[#aaa] hover:text-[#555] transition-colors duration-300 uppercase"
              >
                {label}
              </Link>
            ))}
        ...
        <div className="flex items-center justify-between pt-8">
          <p className="font-body text-[10px] text-[#ccc] tracking-widest">
